...
public class GeoCode64Test {

    private static final double DELTA = 0.0000001; // Acceptable precision for latitude/longitude

    @Test
    void testEncodeDecodeWithCities() {
        GeoCode64 geoCode64 = new GeoCode64();
        ...
        for (int i = 0; i < cities.length; i++) {
            ...
            // Encode
            long encoded = geoCode64.encode(originalLat, originalLon);

            // Decode
            double[] decoded = geoCode64.decodeToDoubleA(encoded);
