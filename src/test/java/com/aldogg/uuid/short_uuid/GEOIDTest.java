...
public class GEOIDTest {
    ...
    public void testGeoId() {
        ...
        Assertions.assertEquals(0b010_1011_1111_0100, lat);
        Assertions.assertEquals(0b1_1001_0010_0110_1110, lon);

        Assertions.assertEquals(0b11_001001_10001110_10111110_01110100, geoid.getGeoID(-12.046374, -77.042793));
